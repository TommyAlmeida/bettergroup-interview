...
async def get_project_details(
    ...
    return ProjectWithMembersResponse(
        ...
        members=[UserResponse.model_validate(user, from_attributes=True) for user in members]
    )
...
async def add_user_to_project(
    ...
    return ProjectMembershipResponse.model_validate(membership, from_attributes=True)
...
async def get_project_members(
    ...
    return [UserResponse.model_validate(user, from_attributes=True) for user in members]
